...
# test the whole dataset and get the Mean Average Precision
# To the best of my knowledge, COCO does not release the testset label on their end.
# Therefore, we use validataion testdataset to evalue our model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='test_result_temporal.png', help='output image')
    parser.add_argument('--model', type=str, default='../output_models/openpose_coco_temporal_shift2_iter_50000.pth', help='path to the weights file')
