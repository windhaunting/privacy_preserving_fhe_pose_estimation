...
# generate keypoint for each file only
# used for testing to get metrics of MAP
...
def parse():
    ...
    parser.add_argument('--img_dir', type=str,
                        dest='img_dir', help='the input_dir for the image, added filename later')
...
def processing(args):
    ...
    for i, img_id in enumerate(ids):
        ...
        name = args.img_dir + '/'+ coco.imgs[img_id]['file_name']
