...
Use FHE  fully homomorphic encryption to do the operation for inference

build the encoded network  for encrpyted image operation
...
class Pose_Estimation(nn.Module):
    ...
    def _make_layer(self, net_dict, batch_norm=False, last_activity=False):
        ...
        print("layerrrrr: ", len(layers), layers)
